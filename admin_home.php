                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
							...
							<li><a class="menu-top-active" href="admin_home.php"><i class="fa fa-home fa-lg" aria-hidden="true"></i>&nbsp&nbsp&nbsp Home</a></li>
					...
					<a name="about"></a>
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <a href=""><img class="img-responsive img-full" src="img/slide-1.jpg" alt="">
                            ...
                            <div class="item">
                                <a href=""><img class="img-responsive img-full" src="img/slide-2.jpg" alt="">
								<div class="carousel-caption">
								<h4>Result</h4>
                            ...
                            <div class="item">
                                <a href=""><img class="img-responsive img-full" src="img/slide-3.jpg" alt="">
								<div class="carousel-caption">
								<h4>Planner</h4>
